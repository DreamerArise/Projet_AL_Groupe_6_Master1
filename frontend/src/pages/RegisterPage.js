  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {message && <p style={{ color: message.includes('réussie') ? '#388e3c' : '#e53935', background: message.includes('réussie') ? '#e8f5e9' : '#ffeaea', borderRadius: 8, padding: '8px 12px', marginTop: 10, fontWeight: 500, textAlign: 'center' }}>{message}</p>}
      </div>
    </div>
  );
};
