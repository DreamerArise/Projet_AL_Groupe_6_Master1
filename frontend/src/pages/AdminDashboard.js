...
export default function AdminDashboard() {
  ...
  return (
    <div style={dashboardStyles}>
      <div style={header}>Tableau de bord Administrateur</div>
        ...
        <ul style={list}>
          {categories.map((cat) => (
            <li key={cat.id} style={card}>
              ...
              <div style={cardActions}>
                <button style={btnCancel} onClick={() => handleCategoryEdit(cat)}>Éditer</button>
                <button style={btn} onClick={() => handleCategoryDelete(cat.id)}>Supprimer</button>
              </div>
            </li>
          ))}
        </ul>
